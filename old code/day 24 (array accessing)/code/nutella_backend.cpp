...
inline void x86_WriteAddIntInt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    string Temp4 = StringConcat(InitStr("add ", 4), Reg1->Name);
...
{
    // TODO: Make sure we are passing the proper typed params here
    string Temp4 = StringConcat(InitStr("fiadd ", 6), Reg1->Name);
    string Temp5 = StringConcat(InitStr(", ", 2), Reg2->Name);
    string Temp6 = StringConcat(Temp5, InitStr("\n", 1));
    string OutputText = StringConcat(Temp4, Temp6);
    fwrite(OutputText.Text, OutputText.NumChars, sizeof(char), State->OutFile);
...
{
    string Temp4 = StringConcat(InitStr("fadd ", 5), Reg1->Name);
    string Temp5 = StringConcat(InitStr(", ", 2), Reg2->Name);
    string Temp6 = StringConcat(Temp5, InitStr("\n", 1));
    string OutputText = StringConcat(Temp4, Temp6);
    fwrite(OutputText.Text, OutputText.NumChars, sizeof(char), State->OutFile);
...
inline void x86_WriteSubIntInt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    string Temp4 = StringConcat(InitStr("sub ", 4), Reg1->Name);
    string Temp5 = StringConcat(InitStr(", ", 2), Reg2->Name);
    string Temp6 = StringConcat(Temp5, InitStr("\n", 1));
    string OutputText = StringConcat(Temp4, Temp6);
    fwrite(OutputText.Text, OutputText.NumChars, sizeof(char), State->OutFile);
...
{
    // TODO: Make sure we are passing the proper typed params here
    string Temp4 = StringConcat(InitStr("fisub ", 6), Reg1->Name);
    string Temp5 = StringConcat(InitStr(", ", 2), Reg2->Name);
    string Temp6 = StringConcat(Temp5, InitStr("\n", 1));
    string OutputText = StringConcat(Temp4, Temp6);
    fwrite(OutputText.Text, OutputText.NumChars, sizeof(char), State->OutFile);
...
{
    string Temp4 = StringConcat(InitStr("fsub ", 5), Reg1->Name);
    string Temp5 = StringConcat(InitStr(", ", 2), Reg2->Name);
    string Temp6 = StringConcat(Temp5, InitStr("\n", 1));
    string OutputText = StringConcat(Temp4, Temp6);
    fwrite(OutputText.Text, OutputText.NumChars, sizeof(char), State->OutFile);
...
inline void x86_WriteMulIntInt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    string Temp4 = StringConcat(InitStr("imul ", 5), Reg1->Name);
    string Temp5 = StringConcat(InitStr(", ", 2), Reg2->Name);
    string Temp6 = StringConcat(Temp5, InitStr("\n", 1));
    string OutputText = StringConcat(Temp4, Temp6);
    fwrite(OutputText.Text, OutputText.NumChars, sizeof(char), State->OutFile);
