...
inline syntax_node* CreateUniSyntaxNode(u32 Id, syntax_node* Child)
{
    syntax_node* Result = CreateSyntaxNode(Id, 1);
...
{
    syntax_node* Result = CreateSyntaxNode(Id, 2);
...
int main(int argc, char** argv)
{
    ...
    SyntaxTreeToIR(&NameState, (syntax_node*)(SyntaxTreeArena.Mem));
