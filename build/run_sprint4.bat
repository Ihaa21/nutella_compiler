...
REM echo test_pointers
nutella_compiler %OutputDir%\test_structs.nutella
ml /Zi /Cx /coff %OutputDir%\test_structs.asm /link /SUBSYSTEM:console
nutella_compiler %OutputDir%\test_structs_args.nutella
ml /Zi /Cx /coff %OutputDir%\test_structs_args.asm /link /SUBSYSTEM:console