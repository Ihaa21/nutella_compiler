...
internal void PushJumpCondInstr(string BoolExprResult, string JumpHeader)
{
    ir_instr Instr = {};
    ...
    CurrByte = PushStruct(&IR_Arena, string);
    memcpy(CurrByte, &BoolExprResult, sizeof(string));
...
internal void ConvertIrToC(FILE* OutFile)
{
    ...
    while (CurrByte < ((u8*)IR_Arena.Mem + IR_Arena.Used))
    {
        ...
        switch(Instr->Id)
        {
            ...
            case IR_JumpCond:
            {
                string* BoolExprResult = (string*)CurrByte;
                CurrByte += sizeof(string);
                string* HeaderName = (string*)CurrByte;
                CurrByte += sizeof(string);
            ...
            case IR_Div:
            {
                ...
                x86_WriteMov(Return->Str, Arg1->Str, OutFile);
                //x86_WriteMul(Return, Arg2, OutFile);
            } break;
