...
inline b32 IsSyntaxNodeUniOp(expression_node* Node)
{
    b32 Result = Node->OperatorId > OpId_StartUniOps && Node->OperatorId < OpId_EndUniOps;
    return Result;
}

inline b32 IsSyntaxNodeBinOp(expression_node* Node)
{
    ...
    switch (Root->OperatorId)
    {
        case OpId_Dereference:
        {
            ...
            *NewType = *TypeRight;
            ...
            PushUniOpInstr(IR_Dereference, RightStr, ResultVarName.Var->Str);
        } break;
        ...
        case OpId_AddressOff:
        {
            ...
            *NewType = *TypeRight;
            ...
            PushDefineInstr(ResultVarName.Var->Type, ResultVarName.Var->Str);
            PushUniOpInstr(IR_AddressOff, RightStr, ResultVarName.Var->Str);
        } break;
        ...
        case OpId_Negate:
        {
            ...
            if (!(TypeRight == GetBasicType(TypeId_Int) ||
            ...
            PushDefineInstr(ResultVarName.Var->Type, ResultVarName.Var->Str);
            PushBinOpInstr(IR_Sub, InitStr("0", 1), RightStr, ResultVarName.Var->Str);
        } break;
