...
inline var* DefineVarInScope(parser_state* State, string Name, type* Type)
{
    ...
    {
        NewVar->Members = PushArray(&VarArena, var, Type->NumMembers);
        ...
        u8* CurrByte = Type->Members;
        for (u32 MemberIndex = 0; MemberIndex < Type->NumMembers; ++MemberIndex)
        {
            ...
            NewVar->Members[MemberIndex].Str = *Str;
            NewVar->Members[MemberIndex].Type = CurrArgType;
        }
    }
