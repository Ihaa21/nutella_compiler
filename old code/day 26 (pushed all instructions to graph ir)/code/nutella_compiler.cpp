...
typed_reg* RegFor0_Int;
typed_reg* RegFor0_Flt;
...
int main(int argc, char** argv)
{
    ...
    RegFor0_Int = PushStruct(&TempArena, typed_reg);
    RegFor0_Int->Reg = PushStruct(&RegArena, virtual_reg);
    {
        char CharFor0 = '0';
        RegFor0_Int->Type = GetBasicType(TypeId_Int);
        RegFor0_Int->Reg->Name.NumChars = 1;
        RegFor0_Int->Reg->Name.Text = &CharFor0;
        RegFor0_Int->Reg->Flags = RegFlag_IsConstVal;
    }
    
    RegFor0_Flt = PushStruct(&TempArena, typed_reg);
    RegFor0_Flt->Reg = PushStruct(&RegArena, virtual_reg);
    {
        char CharFor0[] = "0.0";
        RegFor0_Flt->Type = GetBasicType(TypeId_Float);
        RegFor0_Flt->Reg->Name.NumChars = 3;
        RegFor0_Flt->Reg->Name.Text = CharFor0;
        RegFor0_Flt->Reg->Flags = RegFlag_IsConstVal;
    }
