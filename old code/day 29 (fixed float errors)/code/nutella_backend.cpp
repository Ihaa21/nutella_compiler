...
inline void x86_WritePush(virtual_reg* Reg, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
...
inline void x86_WritePop(virtual_reg* Reg, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
...
inline void x86_WriteAddFltInt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
    AddString("push ", 5, &StrState);
    AddString(Reg1->Name, &StrState);
    ...
    AddString("fiadd dword ptr[esp]\n", 21, &StrState);
    
    AddString("sub esp, 4\n", 11, &StrState);
    AddString("fst dword ptr [esp]\n", 20, &StrState);
...
inline void x86_WriteAddFltFlt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
    AddString("push ", 5, &StrState);
    AddString(Reg1->Name, &StrState);
...
inline void x86_WriteSubFltInt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
    AddString("push ", 5, &StrState);
    AddString(Reg1->Name, &StrState);
...
inline void x86_WriteSubFltFlt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
    AddString("push ", 5, &StrState);
    AddString(Reg1->Name, &StrState);
...
inline void x86_WriteMulFltInt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
    AddString("push ", 5, &StrState);
    AddString(Reg1->Name, &StrState);
...
inline void x86_WriteMulFltFlt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
    AddString("push ", 5, &StrState);
    AddString(Reg1->Name, &StrState);
...
inline void x86_WriteDivIntFlt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
    AddString("push ", 5, &StrState);
    AddString(Reg1->Name, &StrState);
...
inline void x86_WriteDivFltInt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
    AddString("push ", 5, &StrState);
    AddString(Reg1->Name, &StrState);
...
inline void x86_WriteDivFltFlt(virtual_reg* Reg1, virtual_reg* Reg2, backend_state* State)
{
    str_build_state StrState = StartBuildingString(&TempArena);
    AddString("push ", 5, &StrState);
    AddString(Reg1->Name, &StrState);
...
internal void ConvertIrToAssembly(mem_arena* IR_Arena, FILE* OutFile)
{
        ...
        switch(Instr->Id)
        {
            case IR_Define:
            {
                ...
                else
                {
                    ...
                    str_build_state StrState = StartBuildingString(&TempArena);
                    AddString(Register->Name, &StrState);
                    fwrite(StrState.Str.Text, StrState.Str.NumChars, sizeof(char), State.OutFile);
                    EndBuildingString(&StrState);
                    
                    Instr->Id = IR_NoOp;
                    u32* SizeInBytes = (u32*)State.CurrByte;
                    *SizeInBytes = sizeof(virtual_reg*);
                }
            ...
            case IR_LoadFromMem:
            {
                if (PrevGlobal)
                {
                    ...
                    virtual_reg* GlobalReg = *((virtual_reg**)(State.CurrByte));
                    virtual_reg* AssignReg = *((virtual_reg**)(State.CurrByte + sizeof(virtual_reg*)));
                    Assert(PrevGlobal == GlobalReg);
                    
                    str_build_state StrState = StartBuildingString(&TempArena);
                    AddString(" DD ", 4, &StrState);
                    AddString(AssignReg->Name, &StrState);
                    AddString("\n", 1, &StrState);
                    fwrite(StrState.Str.Text, StrState.Str.NumChars, sizeof(char), State.OutFile);
                    EndBuildingString(&StrState);
                    ...
                    Instr->Id = IR_NoOp;
                    u32* SizeInBytes = (u32*)State.CurrByte;
                    *SizeInBytes = 2*sizeof(virtual_reg*);
                }
    ...
    while (State.CurrByte < ((u8*)IR_Arena->Mem + IR_Arena->Used))
    {
        ...
        switch(Instr->Id)
        {
            ...
            case IR_Return:
            {
                virtual_reg* Reg = GetRegisterFromIR(&State);
                function* Func = *((function**)State.CurrByte);
                State.CurrByte += sizeof(function*);
