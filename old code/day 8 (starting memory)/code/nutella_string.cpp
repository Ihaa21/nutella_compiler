...
{
    string Result = {};
    Result.Text = (char*)malloc(sizeof(char)*NumChars);
...
inline u32 NumCharsToNonAlpha(char* CurrChar, u32 CurrCharCount, u32 NumChars)
{
    u32 Result = 0;

    //while (!(IsCharWhiteSpace(*CurrChar) || *CurrChar == ';'))
