...
inline void x86_WriteAdd(string Reg1, string Reg2, FILE* OutFile)
{
    char Temp1[] = "add ";
    char Temp2[] = ", ";
    char Temp3[] = "\n";

    string Temp4 = StringConcat(InitStr(Temp1, 4), Reg1);
    string Temp5 = StringConcat(InitStr(Temp2, 2), Reg2);
    string Temp6 = StringConcat(Temp5, InitStr(Temp3, 1));
...
inline void x86_WriteMov(string Reg1, string Reg2, FILE* OutFile)
{
    char Temp1[] = "mov ";
    char Temp2[] = ", ";
    char Temp3[] = "\n";
    ...
    while (CurrByte < ((u8*)IR_Arena.Mem + IR_Arena.Used))
    {
        ...
        {            
            ...
            case IR_Add:
            {
                ...
                x86_WriteMov(*Return, *Arg1, OutFile);
